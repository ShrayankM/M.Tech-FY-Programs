...
#* Keep track of the Last Completed checkpoint
masterRecord = [0, 0]
...
class CheckPoint:
    def __init__(self, ATT, DPT):
        self.ATT = copy.deepcopy(ATT)
        self.DPT = copy.deepcopy(DPT)
...
def view_system_state(state):
    ...
    print()
    print("  DISK MEMORY [NON-Volatile]")
    pages = []
